 ...
 * @version 1.0
 */
class InstrRecordBase {

    private GCInstruction instr = null;

    public InstrRecordBase() {

    }
    
    public InstrRecordBase(GCInstruction instr) {
        this.instr = instr;
    }
    ...
    public boolean equals(Object obj) {
        ...
        InstrRecordBase input = (InstrRecordBase) obj;
    ...
    public int hashCode() {
        int hash = 5;
        hash = 53 * hash + (this.instr != null ? this.instr.hashCode() : 0);
        return hash;
    }
}
