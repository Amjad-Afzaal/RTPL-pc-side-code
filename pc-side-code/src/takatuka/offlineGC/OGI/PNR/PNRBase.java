 ...
 * @version 1.0
 */
public class PNRBase extends PNRAlgo {

    private static final PNRBase myObj = new PNRBase();
    ...
    protected void setFactory() {
        IFactory factory = PNRFactory.getInstanceOf();
     ...
     * @return
     */
    public static PNRBase getInstanceOf() {
        return myObj;
    }

    public void anyThingWithVirtualThread(VirtualThread vThread) {
    }
