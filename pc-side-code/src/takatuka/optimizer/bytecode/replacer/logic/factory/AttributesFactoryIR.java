 ...
 */
package takatuka.optimizer.bytecode.replacer.logic.factory;
 ...
 * @version 1.0
 */
public class AttributesFactoryIR extends AttributesFactoryBH {

    private static final AttributesFactoryIR attributeFactoryBH =
            new AttributesFactoryIR();

    protected AttributesFactoryIR() {
        super();
    }
    ...
    protected Instruction createInstruction(int opcode, Un operands, CodeAtt codeAtt) throws
            Exception {
        return new IRInstruction(opcode, operands, codeAtt);
    }
}
