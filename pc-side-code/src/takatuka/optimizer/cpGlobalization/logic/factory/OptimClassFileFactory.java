 ...
 * @version 1.0
 */
public class OptimClassFileFactory extends DCClassFileFactory {
    private static final OptimClassFileFactory classFileFactory = new
            OptimClassFileFactory();
    protected OptimClassFileFactory() {
        super();
    }
    ...
    protected ClassFile createClassFile(MultiplePoolsFacade cstPool,
            ...
            Exception {
        return new OptimizedClassFile(cstPool, uniqueName);
    }
