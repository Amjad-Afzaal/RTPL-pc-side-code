 ...
 * @version 1.0
 */
public class LFLongInfo extends LongInfo implements LFBaseObject {

    private Un address = null;

    public LFLongInfo(byte tag) throws TagException, Exception {
        super(tag);
    }

    public LFLongInfo() throws TagException, Exception {
        super();
    }
