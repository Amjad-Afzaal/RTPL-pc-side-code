 ...
 * @version 1.0
 */
public class LFNameAndTypeInfo extends NameAndTypeInfo implements LFBaseObject {

    private Un address = null;

    public LFNameAndTypeInfo() throws TagException, Exception {
        super();
    }
    ...
    public String writeSelected(BufferedByteCountingOutputStream buff) throws
            Exception {
        return "\tNameAndTypeInfo= //" + super.writeSelected(null)+ ", address="+getAddress();
    }
