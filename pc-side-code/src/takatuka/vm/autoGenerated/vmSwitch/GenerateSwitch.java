...
public class GenerateSwitch {
    ...
    private final static GenerateSwitch switchGen = new GenerateSwitch();
    ...
    private void generateCasesForSingleInst() {
        ...
        while (it.hasNext()) {
            ...
            //cloning (could also do it in the clone function).
            ...
            //todo null should be replace if to be used switch
            updateMap(newInstbytecodeDefMap, newOcAc, singInstRec.operandSize,
                    singInstRec.fixOperand,
    ...
    static void updateMap(HashMap<Integer, OpCodeAndCode> opcodeAndcodeMap,
            OpCodeAndCode opcodeAndCode, int size, Un fixedArg,
            Vector<Integer> parameterSizes) {
        try {
            /**
             * The following code could be written better. I will improve it later on.
             */
